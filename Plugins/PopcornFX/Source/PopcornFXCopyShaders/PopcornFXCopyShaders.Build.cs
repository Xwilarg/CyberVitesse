...
{
	public class PopcornFXCopyShaders : ModuleRules
	{
		bool					IAmDeveloping = false;

#if WITH_FORWARDED_MODULE_RULES_CTOR
		public PopcornFXCopyShaders(ReadOnlyTargetRules Target) : base(Target)
#else
		public PopcornFXCopyShaders(TargetInfo Target)
