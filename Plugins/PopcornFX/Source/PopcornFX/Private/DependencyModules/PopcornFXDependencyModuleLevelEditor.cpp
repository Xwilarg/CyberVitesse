...
void	FPopcornFXDependencyModuleLevelEditor::OpenSourcePack()
{
	...
	HH_ASSERT(m_Loaded);
	HH_ASSERT(m_Settings != null);
	HH_ASSERT(m_Settings->bSourcePackFound);
