...
#ifndef	__EU_INIT_H__
#define	__EU_INIT_H__

#include "hh_engine_utils/include/eu_config.h"
...
class	HH_ENGINEUTILS_EXPORT CHHEngineUtilsBase
{
public:
	struct	Config
	{
...
public:
	static const char	*LibraryName() { return "HH-EngineUtils"; }
	static bool			Active() { return m_Active; }
};

//----------------------------------------------------------------------------

typedef	THHLibrary<CHHEngineUtilsBase>	CHHEngineUtils;

// FIXME: Uncomment this for dlls, but THHLibrary<Type> will need to be instanciated inside a cpp
// template class HH_ENGINEUTILS_EXPORT	THHLibrary<CHHEngineUtilsBase>;
