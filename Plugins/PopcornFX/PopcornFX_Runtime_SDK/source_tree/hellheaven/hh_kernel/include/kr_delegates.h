...
#if defined (__DMC__) || defined(__GNUC__) || defined(__ICL) || defined(__COMO__) || defined(__SNC__)
#define FASTDELEGATE_ALLOW_FUNCTION_TYPE_SYNTAX
#endif
...
#if	defined(__GNUC__) || defined(__SNC__) // Workaround GCC bug #8271
...
inline OutputClass horrible_cast(const InputClass input) {
	...
	HH_STATIC_ASSERT(sizeof(InputClass) == sizeof(u)
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + sizeof(int)> {
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
		...
		HH_STATIC_ASSERT(sizeof(function_to_bind) == sizeof(u.s));
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3*sizeof(int)>
{
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind,
		...
		// Check that the horrible_cast will work
		HH_STATIC_ASSERT(sizeof(XFuncType) == sizeof(u.s));
...
// support static_cast between void * and function pointers.
	...
	inline void bindstaticfunc(DerivedClass *pParent, ParentInvokerSig static_function_invoker,
		...
		HH_STATIC_ASSERT(sizeof(GenericClass *) == sizeof(function_to_bind));
...
//		m_pthis = reinterpret_cast<GenericClass *>(reinterpret_cast<long>(function_to_bind));
	...
	inline UnvoidStaticFuncPtr GetStaticFunction() const {
		...
		HH_STATIC_ASSERT(sizeof(UnvoidStaticFuncPtr) == sizeof(this));
#endif
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))();
	}
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self, Param1 p1) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))(p1);
	}
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self, Param1 p1, Param2 p2) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))(p1, p2);
	}
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self, Param1 p1, Param2 p2, Param3 p3) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))(p1, p2, p3);
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self, Param1 p1, Param2 p2, Param3 p3, Param4 p4) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))(p1, p2, p3, p4);
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self, Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))(p1, p2, p3, p4, p5);
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self, Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))(p1, p2, p3, p4, p5, p6);
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self, Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))(p1, p2, p3, p4, p5, p6, p7);
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	// UNSAFE: should only be called when the delegate has been setup with a null 'pthis'
	RetType ReboundInvoke(void *self, Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) const
	{
		return (((detail::GenericClass*)((size_t)m_Closure.GetClosureThis() + (char*)self))->*(m_Closure.GetClosureMemPtr()))(p1, p2, p3, p4, p5, p6, p7, p8);
	}
	// Implicit conversion to "bool" using the safe_bool idiom
private:
	typedef struct SafeBoolStruct {
...
public:
	...
	// Params Types definition
	typedef R RetType;
	typedef void const *Param1;
	typedef void const *Param2;
	typedef void const *Param3;
	typedef void const *Param4;
	typedef void const *Param5;
	typedef void const *Param6;
	typedef void const *Param7;
	typedef void const *Param8;
};
...
template<typename R, class _Param1>
class FastDelegate<R (_Param1)>
	// Inherit from FastDelegate1 so that it can be treated just like a FastDelegate1
	: public FastDelegate1<_Param1, R>
{
public:
	// Make using the base type a bit easier via typedef.
	typedef FastDelegate1<_Param1, R> BaseType;
	...
	template<class X, class Y>
	FastDelegate(Y * pthis,
			R (X::* function_to_bind)(_Param1 p1))
		: BaseType(pthis, function_to_bind) { }

	template<class X, class Y>
	FastDelegate(const Y *pthis,
			R (X::* function_to_bind)(_Param1 p1) const)
		: BaseType(pthis, function_to_bind)
	{ }

	FastDelegate(R (*function_to_bind)(_Param1 p1))
		: BaseType(function_to_bind) { }
	void operator = (const BaseType &x) {
		*static_cast<BaseType*>(this) = x; }
...
template<typename R, class _Param1, class _Param2>
class FastDelegate<R (_Param1, _Param2)>
	// Inherit from FastDelegate2 so that it can be treated just like a FastDelegate2
	: public FastDelegate2<_Param1, _Param2, R>
{
public:
	// Make using the base type a bit easier via typedef.
	typedef FastDelegate2<_Param1, _Param2, R> BaseType;
	...
	template<class X, class Y>
	FastDelegate(Y * pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2))
		: BaseType(pthis, function_to_bind) { }

	template<class X, class Y>
	FastDelegate(const Y *pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2) const)
		: BaseType(pthis, function_to_bind)
	{ }

	FastDelegate(R (*function_to_bind)(_Param1 p1, _Param2 p2))
		: BaseType(function_to_bind) { }
	void operator = (const BaseType &x) {
		*static_cast<BaseType*>(this) = x; }
...
//N=3
// Specialization to allow use of
// FastDelegate<R (Param1, _Param2, _Param3)>
// instead of
// FastDelegate3<Param1, _Param2, _Param3, R>
template<typename R, class _Param1, class _Param2, class _Param3>
class FastDelegate<R (_Param1, _Param2, _Param3)>
	// Inherit from FastDelegate3 so that it can be treated just like a FastDelegate3
	: public FastDelegate3<_Param1, _Param2, _Param3, R>
{
public:
	// Make using the base type a bit easier via typedef.
	typedef FastDelegate3<_Param1, _Param2, _Param3, R> BaseType;
	...
	template<class X, class Y>
	FastDelegate(Y * pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3))
		: BaseType(pthis, function_to_bind) { }

	template<class X, class Y>
	FastDelegate(const Y *pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3) const)
		: BaseType(pthis, function_to_bind)
	{ }

	FastDelegate(R (*function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3))
		: BaseType(function_to_bind) { }
	void operator = (const BaseType &x) {
		*static_cast<BaseType*>(this) = x; }
...
//N=4
// Specialization to allow use of
// FastDelegate<R (Param1, _Param2, _Param3, _Param4)>
// instead of
// FastDelegate4<Param1, _Param2, _Param3, _Param4, R>
template<typename R, class _Param1, class _Param2, class _Param3, class _Param4>
class FastDelegate<R (_Param1, _Param2, _Param3, _Param4)>
	// Inherit from FastDelegate4 so that it can be treated just like a FastDelegate4
	: public FastDelegate4<_Param1, _Param2, _Param3, _Param4, R>
{
public:
	// Make using the base type a bit easier via typedef.
	typedef FastDelegate4<_Param1, _Param2, _Param3, _Param4, R> BaseType;
	...
	template<class X, class Y>
	FastDelegate(Y * pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4))
		: BaseType(pthis, function_to_bind) { }

	template<class X, class Y>
	FastDelegate(const Y *pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4) const)
		: BaseType(pthis, function_to_bind)
	{ }

	FastDelegate(R (*function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4))
		: BaseType(function_to_bind) { }
	void operator = (const BaseType &x) {
		*static_cast<BaseType*>(this) = x; }
...
//N=5
// Specialization to allow use of
// FastDelegate<R (Param1, _Param2, _Param3, _Param4, _Param5)>
// instead of
// FastDelegate5<Param1, _Param2, _Param3, _Param4, _Param5, R>
template<typename R, class _Param1, class _Param2, class _Param3, class _Param4, class _Param5>
class FastDelegate<R (_Param1, _Param2, _Param3, _Param4, _Param5)>
	// Inherit from FastDelegate5 so that it can be treated just like a FastDelegate5
	: public FastDelegate5<_Param1, _Param2, _Param3, _Param4, _Param5, R>
{
public:
	// Make using the base type a bit easier via typedef.
	typedef FastDelegate5<_Param1, _Param2, _Param3, _Param4, _Param5, R> BaseType;
	...
	template<class X, class Y>
	FastDelegate(Y * pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5))
		: BaseType(pthis, function_to_bind) { }

	template<class X, class Y>
	FastDelegate(const Y *pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5) const)
		: BaseType(pthis, function_to_bind)
	{ }

	FastDelegate(R (*function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5))
		: BaseType(function_to_bind) { }
	void operator = (const BaseType &x) {
		*static_cast<BaseType*>(this) = x; }
...
//N=6
// Specialization to allow use of
// FastDelegate<R (Param1, _Param2, _Param3, _Param4, _Param5, _Param6)>
// instead of
// FastDelegate6<Param1, _Param2, _Param3, _Param4, _Param5, _Param6, R>
template<typename R, class _Param1, class _Param2, class _Param3, class _Param4, class _Param5, class _Param6>
class FastDelegate<R (_Param1, _Param2, _Param3, _Param4, _Param5, _Param6)>
	// Inherit from FastDelegate6 so that it can be treated just like a FastDelegate6
	: public FastDelegate6<_Param1, _Param2, _Param3, _Param4, _Param5, _Param6, R>
{
public:
	// Make using the base type a bit easier via typedef.
	typedef FastDelegate6<_Param1, _Param2, _Param3, _Param4, _Param5, _Param6, R> BaseType;
	...
	template<class X, class Y>
	FastDelegate(Y * pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6))
		: BaseType(pthis, function_to_bind) { }

	template<class X, class Y>
	FastDelegate(const Y *pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6) const)
		: BaseType(pthis, function_to_bind)
	{ }

	FastDelegate(R (*function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6))
		: BaseType(function_to_bind) { }
	void operator = (const BaseType &x) {
		*static_cast<BaseType*>(this) = x; }
...
//N=7
// Specialization to allow use of
// FastDelegate<R (Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7)>
// instead of
// FastDelegate7<Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7, R>
template<typename R, class _Param1, class _Param2, class _Param3, class _Param4, class _Param5, class _Param6, class _Param7>
class FastDelegate<R (_Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7)>
	// Inherit from FastDelegate7 so that it can be treated just like a FastDelegate7
	: public FastDelegate7<_Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7, R>
{
public:
	// Make using the base type a bit easier via typedef.
	typedef FastDelegate7<_Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7, R> BaseType;
	...
	template<class X, class Y>
	FastDelegate(Y * pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6, _Param7 p7))
		: BaseType(pthis, function_to_bind) { }

	template<class X, class Y>
	FastDelegate(const Y *pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6, _Param7 p7) const)
		: BaseType(pthis, function_to_bind)
	{ }

	FastDelegate(R (*function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6, _Param7 p7))
		: BaseType(function_to_bind) { }
	void operator = (const BaseType &x) {
		*static_cast<BaseType*>(this) = x; }
	...
	typedef _Param5 Param5;
	typedef _Param6 Param6;
	typedef _Param7 Param7;
	typedef void const *Param8;
};

//N=8
// Specialization to allow use of
// FastDelegate<R (Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7, _Param8)>
// instead of
// FastDelegate8<Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7, _Param8, R>
template<typename R, class _Param1, class _Param2, class _Param3, class _Param4, class _Param5, class _Param6, class _Param7, class _Param8>
class FastDelegate<R (_Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7, _Param8)>
	// Inherit from FastDelegate8 so that it can be treated just like a FastDelegate8
	: public FastDelegate8<_Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7, _Param8, R>
{
public:
	// Make using the base type a bit easier via typedef.
	typedef FastDelegate8<_Param1, _Param2, _Param3, _Param4, _Param5, _Param6, _Param7, _Param8, R> BaseType;
	...
	template<class X, class Y>
	FastDelegate(Y * pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6, _Param7 p7, _Param8 p8))
		: BaseType(pthis, function_to_bind) { }

	template<class X, class Y>
	FastDelegate(const Y *pthis,
			R (X::* function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6, _Param7 p7, _Param8 p8) const)
		: BaseType(pthis, function_to_bind)
	{ }

	FastDelegate(R (*function_to_bind)(_Param1 p1, _Param2 p2, _Param3 p3, _Param4 p4, _Param5 p5, _Param6 p6, _Param7 p7, _Param8 p8))
		: BaseType(function_to_bind) { }
	void operator = (const BaseType &x) {
		*static_cast<BaseType*>(this) = x; }
